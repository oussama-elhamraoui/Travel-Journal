...
const SignUpPage = () => {
    ...
    async function loginUser(user,navigate,setMessage){
        try{
          const response = await api.post('http://localhost:5000/api/login',user,{ withCredentials: true });
    ...
    async function handleSubmit(event) {
        ...
        try {
          console.log(user)
          await loginUser(user,navigate,setMessage);
        } catch (error) {

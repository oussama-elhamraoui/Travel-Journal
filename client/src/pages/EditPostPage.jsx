...
const EditPostPage = ({updatePost}) => {
    ...
    const [post, setPost] = useState({
      ...
      startdate: new Date(postData.startdate).toISOString().slice(0, 10) ,
      enddate:new Date(postData.enddate).toISOString().slice(0, 10) ,
